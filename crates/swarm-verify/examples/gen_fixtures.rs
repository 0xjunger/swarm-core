//! Regenerates `crates/swarm-verify/tests/fixtures/*` (`docs/spec.md`
//! §20.7, E7a). The fixture corpus is committed to the repo like the golden
...
fn main() {
    ...
    fs::write(dir.join("truncated.spec"), fixture_data::truncated_spec().encode())
        .expect("write truncated.spec");

    println!("wrote fixtures to {}", dir.display());
}

fn write(dir: &Path, name: &str, (bundle, spec): (swarm_core::bundle::LogBundle, swarm_core::bundle::Spec)) {
